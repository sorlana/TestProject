        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NopCommerceOrderId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthenticationLogs_EventType_Timestamp",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthenticationLogs_UserId_Timestamp",
                table: "AuthenticationLogs",
                columns: new[] { "UserId", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_PhoneVerificationCodes_PhoneNumber_IsUsed_ExpiresAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSubscriptions_NopCommerceOrderId",
                table: "UserSubscriptions",
                column: "NopCommerceOrderId",
                filter: "\"NopCommerceOrderId\" IS NOT NULL");
